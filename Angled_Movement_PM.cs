...
public class Angled_Movement_PM : MonoBehaviour
{
    ...
    public bool ElevatorAudio2 = false;
    ...
    void Restart()
    {
        if (Input.GetKeyDown(KeyCode.R) && WinLoseAudio == true)
        {
    ...
    void Throw()
    {
        if(SpaceStart == true)
        {
            ...
            {
                AmbienceMaker.PlayOneShot(AmbienceBGM, 0.05f);
                AmbienceAudio = true;
            }
